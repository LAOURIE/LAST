...
// Add more colors if you have more bots
const colors = ["bot-card-blue", "bot-card-green", "bot-card-yellow", "bot-card-red"];

    useEffect(() => {
        fetch("https://json-server-g7s4.onrender.com/bots")
    ...
    const removeFromCollection = (id) => {
        ...
        fetch(`https://json-server-g7s4.onrender.com/bots/${id}`, {
            method: "DELETE",
            headers: {
        ...
        <div>
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3">
                {filteredBots.sort(sortChange(sortChoice)).map((bot) => (
                    <div className="col-lg-2 mb-3" key={bot.id}>
                        <div className="card h-100">
                            ...
                            <button className="button1" onClick={() => removeFromCollection(bot.id)}>
                                x
                            </button>
